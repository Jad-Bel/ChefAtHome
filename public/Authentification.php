...
<body class="bg-black text-white ">
    ...
    <!-- sign-in-up-form -->
    <div class="flex flex-col h-screen justify-center items-center bg-zinc-500 min-h-[100vh] pb-5">
           
            <div class="border w-full flex justify-end">
                <button class="text-white text-right w-32 p-2 border">Sign In</button>
            </div>
                        ...
                        <div class="grid gap-4">
                            <div class="grid gap-2">
                                <label class="text-white" for="email">Email</label><input
                                    class="mr-2.5 mb-2 h-full min-h-[44px] w-full border bg-zinc-950 text-white border-zinc-800 px-4 py-3 text-sm font-medium placeholder:text-zinc-400 focus:outline-0 dark:border-zinc-800 dark:bg-transparent dark:text-white dark:placeholder:text-zinc-400"
        ...
        c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z">
                            ...
                            <button class="flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-zinc-800 bg-none hover:bg-accent hover:text-accent-foreground h-10 px-4 w-full text-white py-6 hover:bg-white hover:text-black duration-700" type="submit">
                                Sign up
                            </button>
                        </div>
                    </form>
    ...
    <div class="px-10 flex flex-col h-screen justify-center items-center bg-zinc-500 min-h-[100vh] pb-5 hidden">
            <div class="border w-full flex justify-end">
                <button class="text-white text-right w-32 p-2 border">Sign Up</button>
            </div>
        <div class="mx-auto flex w-full flex-col justify-center px-5 pt-0 md:h-[unset] md:max-w-[50%] lg:h-[100vh] min-h-[100vh] lg:max-w-[50%] lg:px-6">
                            ...
                            <div class="grid gap-2">
                                <div class="flex gap-2 border h-40">
                                    ...
                                    <label class="text-white" for="email">
                                        <input class="mr-2.5 mb-5 h-full min-h-[44px] w-full border bg-zinc-950 text-white border-zinc-800 px-4 py-3 text-sm font-medium placeholder:text-zinc-400 focus:outline-0 dark:border-zinc-800 dark:bg-transparent dark:text-white dark:placeholder:text-zinc-400" id="email" placeholder="First-name" type="email" autocapitalize="none" autocomplete="email" autocorrect="off" name="email" />
                                    </label>
                                    
                                    <label class="text-white" for="email">
                                        <input class="mr-2.5 mb-5 h-full min-h-[44px] w-full border bg-zinc-950 text-white border-zinc-800 px-4 py-3 text-sm font-medium placeholder:text-zinc-400 focus:outline-0 dark:border-zinc-800 dark:bg-transparent dark:text-white dark:placeholder:text-zinc-400" id="email" placeholder="Last-name" type="email" autocapitalize="none" autocomplete="email" autocorrect="off" name="email" />
                                    </label>
