...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $plate_menu = $_POST['plateMenu'];
        ...
        $sql = "UPDATE plats SET `plat_id` = '$plate_id', `plat_nom` = '$plate_name', `description` = '$plate_description', `type` = '$plate_categorie', `menu_id` = '$plate_menu'";
        $result = $connect->query($sql);
    ...
    <div class="min-h-screen flex">
        <aside class="w-64 bg-white border-r">
            ...
            <nav class="mt-6">
                ...
                <a href="../menusAdmin.php" class="flex items-center px-6 py-3 text-gray-600 hover:bg-zinc-700 hover:text-white :transition-all duration-700">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
                    Menus
                </a>
                <a href="../platesAdmin.php" class="flex items-center px-6 py-3 bg-zinc-700 text-white">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div id="adminView" class="w-[250px] md:w-full max-w-7xl ">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="../bin/modifyplate.php?plat_id=<?= $value['plat_id']?>" class="text-indigo-600 p-2 hover:text-white hover:bg-indigo-600 hover:transition-all duration-500 mr-2">Edit</a>
                    ...
                    <div class="bg-white -lg shadow mt-6">
                        <div class="p-6 border-b">
                            <h3 class="text-xl font-semibold">Modify Plate</h3>
                        </div>
                            <?php 
                            ...
                            ?>
                        <div class="p-6">
                            <form class="space-y-4" method="POST" action="../bin/modifyPlate.php">
